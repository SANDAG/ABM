...
def external_non_mandatory_destination(
    ...
    estimator = estimation.manager.begin_estimation('external_non_mandatory_destination')
    if estimator:
...
def external_joint_tour_destination(
    ...
    joint_ext_tours = tours[
        ...
        & (tours.get('is_external_tour', False) == True)]  # get needed incase no joint tours
