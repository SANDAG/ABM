...
doc['cost_per_mile_fuel'] = float(paramByYear.loc[paramByYear.year==scenYear, 'aoc.fuel'].values[0])
doc['cost_per_mile_maint'] = float(paramByYear.loc[paramByYear.year==scenYear, 'aoc.maintenance'].values[0])
