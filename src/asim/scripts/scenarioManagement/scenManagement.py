...
doc['CONSTANTS']['taxiCostInitial'] = float(paramByYear.loc[paramByYear.year==scenYear, 'taxi.baseFare'].values[0])
...
doc['CONSTANTS']['taxiCostPerMile'] = float(paramByYear.loc[paramByYear.year==scenYear, 'taxi.costPerMile'].values[0])
doc['CONSTANTS']['taxiCostPerMinute'] = float(paramByYear.loc[paramByYear.year==scenYear, 'taxi.costPerMinute'].values[0])
doc['CONSTANTS']['ridehailCostInitial'] = float(paramByYear.loc[paramByYear.year==scenYear, 'TNC.single.baseFare'].values[0])
doc['CONSTANTS']['ridehailCostPerMile'] = float(paramByYear.loc[paramByYear.year==scenYear, 'TNC.single.costPerMile'].values[0])
doc['CONSTANTS']['ridehailCostPerMinute'] = float(paramByYear.loc[paramByYear.year==scenYear, 'TNC.single.costPerMinute'].values[0])
doc['CONSTANTS']['ridehailCostMinimum'] = float(paramByYear.loc[paramByYear.year==scenYear, 'TNC.single.costMinimum'].values[0])
