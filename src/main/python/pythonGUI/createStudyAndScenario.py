...
#wsu update 1/30/2019 for release 14.1.1
import Tkinter
import Tkconstants
import tkFileDialog
import os
...
class CreateScenarioGUI(Tkinter.Frame):
        def __init__(self, root):
            ...
            self.defaultNetworkDir="T:\\projects\\sr14\\version14_1_1\\network_build"
            ...
            var = StringVar(root)
            self.version="version_14_1_1"
            optionList=["version_14_1_1"]
            ...
            var = StringVar(root)
            self.year="2016"
            yearOptionList = ["2016", "2020", "2023", "2025", "2025nb", "2026", "2029", "2030", "2032", "2035", "2035nb", "2040", "2050","2050nb"]
