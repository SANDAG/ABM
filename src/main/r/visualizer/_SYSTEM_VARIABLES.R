...
tourMode              <- c('Auto SOV','Auto 2 Person','Auto 3+ Person','Walk','Bike/Moped','Walk-Transit','PNR-Transit','KNR-Transit_PERS','KNR-Transit_TNC','Taxi','TNC','School Bus')
tripMode              <- c('Auto SOV','Auto 2 Person','Auto 3+ Person','Walk','Bike/Moped','Walk-Transit','PNR-Transit','KNR-Transit_PERS','KNR-Transit_TNC','Taxi','TNC','School Bus')
