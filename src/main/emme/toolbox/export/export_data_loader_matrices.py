    ...
    def transit_skims(self):
        ...
        for period in self.periods:
            ...
            with gen_utils.ExportOMX(omx_file, self.transit_scenario) as exporter:
                ...
                exporter.write_clipped_array(bus_ivtt, "IVT:LB", 0, 199.99)
                exporter.write_clipped_array(lrt_ivtt, "IVT:LR", 0, 199.99)
                exporter.write_clipped_array(cmr_ivtt, "IVT:CR", 0, 199.99)
                exporter.write_clipped_array(prem_bus_ivtt, "IVT:EXP", 0, 199.99)
                exporter.write_clipped_array(brt_ivtt, "IVT:BRT", 0, 199.99)
