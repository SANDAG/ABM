...
start %JAVA_64_PATH%\bin\java -server -Dname=p%JAVA_32_PORT% -Xms%MEMORY_MTXMGR_MIN% -Xmx%MEMORY_MTXMGR_MAX% -cp "%CLASSPATH%" -Dlog4j.configuration=log4j_mtx.xml -DJAVA_HOME_32=%JAVA_64_PATH% -DJAVA_32_PORT=%JAVA_32_PORT% org.sandag.abm.ctramp.MatrixDataServer -hostname %HOST_IP_ADDRESS% -port %MATRIX_MANAGER_PORT% -ram 1500 -label "SANDAG Matrix Server"
