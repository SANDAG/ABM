...
%JAVA_64_PATH%\bin\java -showversion -server -Xms1000m -Xmx2000m -cp "%CLASSPATH%" -Dlog4j.configuration=log4j_AtTransitCheck.xml -Dproject.folder=%PROJECT_DIRECTORY% -Djppf.config=jppf-clientDistributed.properties org.sandag.abm.utilities.TapAtConsistencyCheck %PROPERTIES_NAME% %PROJECT_DRIVE%%PROJECT_DIRECTORY%\input
