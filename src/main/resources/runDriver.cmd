...
rem ############  JPPF DRIVER  ############
set JPPF_LIB=%PROJECT_DIRECTORY%\bin\jppf-server-2.5.jar;%PROJECT_DIRECTORY%\application\jppf-common-2.5.jar;%PROJECT_DIRECTORY%\application\jppf-common-node-2.5.jar;%PROJECT_DIRECTORY%\application\crowbar-unknown.jar
