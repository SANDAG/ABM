...
python %PROJECT_DRIVE%%PROJECT_DIRECTORY%\python\calculate_micromobility.py  --properties_file %PROJECT_DRIVE%%PROJECT_DIRECTORY%\conf\sandag_abm.properties --outputs_directory %PROJECT_DRIVE%%PROJECT_DIRECTORY%\outputs --inputs_parent_directory %PROJECT_DRIVE%%PROJECT_DIRECTORY%
