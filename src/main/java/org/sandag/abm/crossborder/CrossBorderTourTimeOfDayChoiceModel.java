...
public class CrossBorderTourTimeOfDayChoiceModel {
	...
	public CrossBorderTourTimeOfDayChoiceModel(HashMap<String,String> rbMap ){
        ...
        String stationDiurnalFile = Util.getStringValueFromPropertyMap(rbMap,"crossBorder.tour.tod.file");
	...
	public void calculateTourTOD(CrossBorderTour tour){
		...
		if(tour.getDebugChoiceModels()){
			logger.info("Choosing tour time of day for purpose "+modelStructure.CROSSBORDER_PURPOSES[purpose]+" using random number "+random);
