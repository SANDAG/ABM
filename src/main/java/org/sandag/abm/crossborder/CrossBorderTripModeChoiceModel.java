...
public class CrossBorderTripModeChoiceModel {
	 ...
	 */
	public CrossBorderTripModeChoiceModel(HashMap<String, String> propertyMap, CrossBorderModelStructure myModelStructure, CrossBorderDmuFactoryIf dmuFactory, McLogsumsCalculator myLogsumHelper ){
	 ...
	 * @param dmuFactory
	 */
    private void setupTripModeChoiceModel( HashMap<String, String> propertyMap, CrossBorderDmuFactoryIf dmuFactory  ) {
     ...
     * 
     * @param tour CrossBorderTour 
     * @param trip CrossBorderTrip 
     * 
      */
