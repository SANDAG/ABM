...
/**
 * This class is the stop purpose choice model for cross border tours.  It is currently based on a static probability distribution
...
public class CrossBorderStopPurposeModel {
	...
	public CrossBorderStopPurposeModel(HashMap<String,String> rbMap ){
        ...
        String stopFrequencyFile = Util.getStringValueFromPropertyMap(rbMap,"crossBorder.stop.purpose.file");
