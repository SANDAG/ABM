...
public class CrossBorderTripTables {
	...
	public void writeTrips(int period, MatrixType mt) {
		...
		fileName[0] = directory
				+ Util.getStringValueFromPropertyMap(rbMap,
						"crossBorder.results.autoTripMatrix") + end;
		fileName[1] = directory
				+ Util.getStringValueFromPropertyMap(rbMap,
						"crossBorder.results.nMotTripMatrix") + end;
		fileName[2] = directory
				+ Util.getStringValueFromPropertyMap(rbMap,
						"crossBorder.results.tranTripMatrix") + end;
		fileName[3] = directory
				+ Util.getStringValueFromPropertyMap(rbMap,
						"crossBorder.results.othrTripMatrix") + end;
	...
	public static void main(String[] args) {
		...
		logger.info(String
				.format("SANDAG Cross-Border Model Trip Table Generation Program using CT-RAMP version %s",
