...
public class CrossBorderStop implements Serializable {
	...
	public void logStopObject(Logger logger, int totalChars) {
		...
		logHelper(logger, "direction: ", inbound ? "inbound" : "outbound",
				totalChars);
		logHelper(logger, inbound ? "outbound departPeriod: "
				: "inbound arrivePeriod: ", period, totalChars);
