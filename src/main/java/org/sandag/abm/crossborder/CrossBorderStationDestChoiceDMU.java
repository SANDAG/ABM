...
public class CrossBorderStationDestChoiceDMU implements Serializable,
		VariableTable {
	...
	protected double[][] sizeTerms; // by purpose, alternative (station-taz or
									// sampled station-mgra)
	protected double[] stationSizeTerms; // by alternative (station-taz or
											// sampled station-mgra)
	protected double[] correctionFactors; // by alternative (sampled
											// station-mgra pair, for full model
											// only)
	protected double[] tourModeLogsums; // by alternative (sampled station-mgra
										// pair, for full model only)
	protected int[] poeNumbers; // by alternative (station-taz or sampled
								// station-mgra)
	protected int[] originTazs; // by alternative (station-taz or sampled
								// station-mgra)
	protected int[] destinationTazs; // by alternative (station-taz or sampled
										// station-mgra)
	...
	public CrossBorderStationDestChoiceDMU(
