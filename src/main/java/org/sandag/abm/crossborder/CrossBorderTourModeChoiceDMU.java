...
public class CrossBorderTourModeChoiceDMU        implements Serializable, VariableTable
{
	...
	/**
	 * @param tourModelsSentri the tourModelsSentri to set
	 */
	...
	/**
	 * @param borderWaitStd the borderWaitStd to set
	 */
	...
	/**
	 * @param borderWaitPed the borderWaitPed to set
	 */
	...
	/**
	 * @param borderWaitSentri the borderWaitSentri to set
	 */
	...
	/**
	 * @param outboundTripMcLogsumDA the outboundTripMcLogsumDA to set
	 */
	...
	/**
	 * @param outboundTripMcLogsumSR2 the outboundTripMcLogsumSR2 to set
	 */
	...
	/**
	 * @param outboundTripMcLogsumSR3 the outboundTripMcLogsumSR3 to set
	 */
	...
	/**
	 * @param outboundTripMcLogsumWalk the outboundTripMcLogsumWalk to set
	 */
	...
	/**
	 * @param inboundTripMcLogsumDA the inboundTripMcLogsumDA to set
	 */
	...
	/**
	 * @param inboundTripMcLogsumSR2 the inboundTripMcLogsumSR2 to set
	 */
	...
	/**
	 * @param inboundTripMcLogsumSR3 the inboundTripMcLogsumSR3 to set
	 */
	...
	/**
	 * @param inboundTripMcLogsumWalk the inboundTripMcLogsumWalk to set
	 */
