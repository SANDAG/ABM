...
public class CrossBorderStopTimeOfDayChoiceModel {
	...
	public CrossBorderStopTimeOfDayChoiceModel(HashMap<String,String> rbMap ){
        ...
        String outboundDurationFile = Util.getStringValueFromPropertyMap(rbMap,"crossBorder.stop.outbound.duration.file");
        String inboundDurationFile = Util.getStringValueFromPropertyMap(rbMap,"crossBorder.stop.inbound.duration.file");
