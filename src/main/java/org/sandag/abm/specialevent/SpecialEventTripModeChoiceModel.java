...
public class SpecialEventTripModeChoiceModel {
	 ...
	 */
	public SpecialEventTripModeChoiceModel(HashMap<String, String> propertyMap, ModelStructure myModelStructure, 
			SpecialEventDmuFactoryIf dmuFactory, McLogsumsCalculator myLogsumHelper, TableDataSet eventData ){
        ...
        saveUtilsAndProbs = Util.getBooleanValueFromPropertyMap(propertyMap,"specialEvent.saveUtilsAndProbs");
	 ...
	 * @param dmuFactory
	 */
    private void setupTripModeChoiceModel( HashMap<String, String> propertyMap, SpecialEventDmuFactoryIf dmuFactory  ) {
     ...
     * 
     * @param tour SpecialEventTour 
     * @param trip SpecialEventTrip
     * 
      */
