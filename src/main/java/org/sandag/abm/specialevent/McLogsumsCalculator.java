...
public class McLogsumsCalculator implements Serializable {
	 ...
	 * @param mcDmuObject
	 */
	public void setTripMcDmuSkimAttributes(SpecialEventTour tour,
			SpecialEventTrip trip, SpecialEventTripModeChoiceDMU mcDmuObject) {
		...
		if (trip.getBestWtdTapPairs() == null) {

			int outSkimPeriod = ModelStructure.getSkimPeriodIndex(departPeriod);
			bestTapPairs = wtd.getBestTapPairs(origMgra, destMgra,
					outSkimPeriod, debug, logger);
			trip.setBestWtdTapPairs(bestTapPairs);
		}

		setWtdTripMcDmuAttributes(mcDmuObject, origMgra, destMgra,
				departPeriod, bestTapPairs, debug);

		if (trip.getBestDtwTapPairs() == null) {

			int outSkimPeriod = ModelStructure.getSkimPeriodIndex(departPeriod);
			bestTapPairs = dtw.getBestTapPairs(origMgra, destMgra,
					outSkimPeriod, debug, logger);
			trip.setBestDtwTapPairs(bestTapPairs);
		}
	...
	private void setNmTripMcDmuAttributes(
			SpecialEventTripModeChoiceDMU tripMcDmuObject, int origMgra,
