        ...
        implements Serializable
{
     ...
     * @param mcDmuObject
     */
    public void setTripMcDmuSkimAttributes(SpecialEventTour tour, SpecialEventTrip trip,
            SpecialEventTripModeChoiceDMU mcDmuObject)
    {
        ...
        setWtdTripMcDmuAttributes(mcDmuObject, origMgra, destMgra, departPeriod, bestTapPairs,
                debug);
        ...
        setDtwTripMcDmuAttributes(mcDmuObject, origMgra, destMgra, departPeriod, bestTapPairs,
                debug);
    ...
    private void setNmTripMcDmuAttributes(SpecialEventTripModeChoiceDMU tripMcDmuObject,
    ...
    private void setWtwTripMcDmuAttributes(SpecialEventTripModeChoiceDMU tripMcDmuObject,
    ...
    private void setWtdTripMcDmuAttributes(SpecialEventTripModeChoiceDMU tripMcDmuObject,
            int origMgra, int destMgra, int departPeriod, int[][] bestTapPairs,
            boolean loggingEnabled)
    {
    ...
    private void setDtwTripMcDmuAttributes(SpecialEventTripModeChoiceDMU tripMcDmuObject,
            int origMgra, int destMgra, int departPeriod, int[][] bestTapPairs,
            boolean loggingEnabled)
    {
