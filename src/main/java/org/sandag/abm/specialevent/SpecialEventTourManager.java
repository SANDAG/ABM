...
public class SpecialEventTourManager {
    ...
    public SpecialEventTourManager(HashMap<String,String> rbMap, TableDataSet eventData){
        ...
        saveUtilsAndProbs = Util.getBooleanValueFromPropertyMap(rbMap,"specialEvent.saveUtilsAndProbs");
	...
	public void generateTours(){
		...
		String partySizeFile = Util.getStringValueFromPropertyMap(rbMap,"specialEvent.partySize.file");
	 ...
	 * 
	 * @param random a uniformly-distributed random number.
	 * @param eventType a string identifying the type of event, which should be a column in the income data table
	 ...
	 * 
	 * @param random a uniformly-distributed random number.
	 * @param eventType a string identifying the type of event, which should be a column in the party size data table
	...
	public void writeOutputFile(HashMap<String,String> rbMap){
		...
		String directory = Util.getStringValueFromPropertyMap(rbMap,"Project.Directory");
        String tourFileName = directory+Util.getStringValueFromPropertyMap(rbMap,"specialEvent.tour.output.file");
        String tripFileName = directory+Util.getStringValueFromPropertyMap(rbMap,"specialEvent.trip.output.file");
		...
		String tourHeaderString = new String("id,eventNumber,eventType,income,partySize,departTime,arriveTime,originMGRA,destinationMGRA,tourMode\n");
		...
		String tripHeaderString = new String("tourID,tripID,originMGRA,destinationMGRA,inbound,originIsTourDestination,destinationIsTourDestination,period,tripMode,boardingTap,alightingTap");
	 ...
	 * @param writer
	 */
	private void writeTrip(SpecialEventTour tour, SpecialEventTrip trip, int tripNumber, PrintWriter writer){
