        ...
        implements Serializable
{
    ...
    /**
     * This method is called initially when the SOA choice models array is created. It would be called subsequently if a shadow pricing methodology is
     * applied to reset the scaled size terms and corresponding availabilities and sample arrays.
     */
    ...
    /**
     * This method is used if the tour/person decision maker is the first one encountered for the purpose and origin taz. Once the sample of
     * alternatives choice probabilities for a purpose and origin taz are computed, they are stored in an array and used by other decision makers with
     * the same purpose and origin taz.
     * 
     * @param probabilitiesList
     *            is the probabilities array for the given purpose in which choice probabilities will be saved for the origin of the tour/place to be
     *            selected.
     * @param cumProbabilitiesList
     *            is the probabilities array for the given purpose in which choice cumulative probabilities will be saved for the origin of the
     *            tour/place to be selected.
     * @param choiceModel
     *            the ChoiceModelApplication object for the purpose
     * @param tour
     *            the tour object for whic destination choice is required, or null if a usual work/school location is being chosen
     * @param person
     *            the person object for whom the choice is being made
     * @param segmentName
     *            the name of the segment the choice is being made for - for logging
     * @param segmentindex
