        ...
        implements Serializable
{
    ...
    public static void main(String[] args)
    {
         ...
         * TOD_UEC_FILE_TARGET ); todUecFileName = uecFileDirectory + todUecFileName;
         * 
         ...
         * (VariableTable) todDmuObject); System.out.println("Subtour departure and duration UEC passed");
         */
