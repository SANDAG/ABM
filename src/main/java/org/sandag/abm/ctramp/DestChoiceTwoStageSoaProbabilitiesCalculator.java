...
public class DestChoiceTwoStageSoaProbabilitiesCalculator
{
     ...
     *            is the distance utility segment index This method signature is the default, assuming that no distance probabilities logging is
     *            required
     */
     ...
     *            is the distance utility DMU object
     * @param distUtilityIndex
     *            is the distance utility segment index This alternative method signature allows distance probabilities logging to be written
     */
