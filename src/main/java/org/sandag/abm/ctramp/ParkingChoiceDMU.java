...
public class ParkingChoiceDMU implements Serializable, VariableTable {
	...
	protected transient Logger logger = Logger
			.getLogger(ParkingChoiceDMU.class);
	...
	public void setDmuIndexValues(int hhId, int origMgra, int destMgra,
			boolean hhDebug) {
	...
	/**
	 * @param mgras
	 *            is the array of MGRAs in parking area from
	 *            "plc.alts.corresp.file". This is a 0-based array
	 */
	...
	/**
	 * @param indices
	 *            is an array of indices representing this person's park
	 *            location choice sample. the index value in this array points
	 *            to the parkAreaMgras element, and the corresponding mgra
	 *            value. This is a 0-based array
	 */
	 ...
	 * @return the distance between the trip origin mgra and the alternative
	 *         park mgra.
	 */
	 ...
	 * @param alt
	 *            is the index value in the alternatives array (0,...,num alts).
	 * @return the distance between the alternative park mgra and the trip
	 *         destination mgra.
	 */
	...
	/**
	 * @return 1 if the altMgra attribute that was set equals the trip
	 *         destination
	 */
