...
public class HouseholdChoiceModels
{
    ...
    public HouseholdChoiceModels( int modelIndex, String restartModelString,
            ...
            double[] pctHighIncome, double[] pctMultipleAutos, double[] avgtts, double[] transpDist, double[] pctDetour,
            double[][][] nonManSoaDistProbs, double[][][] nonManSoaSizeProbs,
            double[][][] subTourSoaDistProbs, double[][][] subTourSoaSizeProbs,
            double[] distanceToCordonsLogsums )
    {
        ...
        runInternalExternalModel = Boolean.parseBoolean(propertyMap.get(CtrampApplication.PROPERTIES_RUN_INTERNAL_EXTERNAL_TRIP));
        ...
        try
        {
            ...
            if (runTransponderModel) {                                               
                tcModel = new TransponderChoiceModel(propertyMap, dmuFactory, accTable, pctHighIncome, pctMultipleAutos, avgtts, transpDist, pctDetour);
            ...
            if ( runInternalExternalModel ) {
                ...
                if ( measureObjectSizes ) logger.info ( "IE size:       " + ObjectUtil.sizeOf( ieModel ) );
            }
