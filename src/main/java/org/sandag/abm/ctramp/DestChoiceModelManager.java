        ...
        implements Serializable
{
    ...
    {
        //logger.info( "beginning of DestChoiceModelManager.getInstance() - objInstance address = " + objInstance );
        if (objInstance == null) {
            objInstance = new DestChoiceModelManager();
            //logger.info( "after new DestChoiceModelManager() - objInstance address = " + objInstance );
            return objInstance;
        }
        else {
            //logger.info( "returning current DestChoiceModelManager() - objInstance address = " + objInstance );
            return objInstance;
        }
    }
            ...
            String dcUecFileName, String soaUecFileName, int soaSampleSize, CtrampDmuFactoryIf dmuFactory, String restartModelString)
    {
        ...
        // get the HouseholdChoiceModelsManager instance and clear the objects that hold large memory references
        ...
        if ( ms == null ) {
            ...
            logger.info(String.format(Thread.currentThread().getName() + ": DestChoiceModelManager connecting to remote MatrixDataServer."));
    ...
    private void clearWorkLocModels()
    {
        ...
        if ( modelQueueWorkLoc != null && ! modelQueueWorkLoc.isEmpty() ) {
            ...
            logger.info( String.format( "%s:  clearing dc choice models modelQueueWorkLoc, thread=%s.", new Date(), Thread.currentThread().getName() ) );
        ...
        if ( modelQueueWork != null && ! modelQueueWork.isEmpty() ) {
            ...
            logger.info( String.format( "%s:  clearing dc choice models modelQueueWork, thread=%s.", new Date(), Thread.currentThread().getName()) );
    ...
    private void clearSchoolLocModels()
    {
        ...
        if ( modelQueueSchoolLoc != null && ! modelQueueSchoolLoc.isEmpty() ) {
            ...
            logger.info( String.format( "%s:  clearing dc choice models modelQueueSchoolLoc, thread=%s.", new Date(), Thread.currentThread().getName()) );
        ...
        if ( modelQueueSchool != null && ! modelQueueSchool.isEmpty() ) {
            ...
            logger.info( String.format( "%s:  clearing dc choice models modelQueueSchool, thread=%s.", new Date(), Thread.currentThread().getName()) );
