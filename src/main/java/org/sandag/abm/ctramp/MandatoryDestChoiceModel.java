        ...
        implements Serializable
{
    ...
    public void applySchoolLocationChoice(Household hh)
    {
        ...
        for (i = 1; i < persons.length; i++)
        {
            ...
            try
            {
                ...
                /**
                 * remove following - don't need non-mandatory accessibility since we're doing shadow pricing for school tours // set the auto
                 * sufficiency dependent non-mandatory accessibility value for the household int autoSufficiency = hh.getAutoSufficiency(); float
                 * accessibility = aggAcc.getAggregateAccessibility( nonMandatoryAccessibilityTypes[autoSufficiency], hh.getHhMgra() );
    ...
    /**
     * 
     * @return an array with chosen mgra, distance to chosen mgra, and logsum to chosen mgra.
     */
