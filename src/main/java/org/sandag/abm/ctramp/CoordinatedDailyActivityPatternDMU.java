 ...
 * 
 */
public class CoordinatedDailyActivityPatternDMU implements Serializable,
		VariableTable {
	...
	public int getUsualWorkLocationIsHomeA() {
		if (personA.getUsualWorkLocation() == ModelStructure.WORKS_AT_HOME_LOCATION_INDICATOR)
			return 1;
		else
			return 0;
	}
	...
	public int getNoUsualWorkLocationA() {
		if (personA.getUsualWorkLocation() > 0
				&& personA.getUsualWorkLocation() != ModelStructure.WORKS_AT_HOME_LOCATION_INDICATOR)
			return 0;
		else
			return 1;
	}
	...
	public int getNoUsualSchoolLocationA() {
		if (personA.getPersonIsStudent() == 1
				&& personA.getUsualSchoolLocation() == personA
						.getHouseholdObject().getHhMgra()
				&& personA.getSchoolLocationDistance() == 0)
			return 0;
		else
			return 1;
	}
	...
	public int getHhSize() {
		...
		int hhSize = Math
				.min(HouseholdCoordinatedDailyActivityPatternModel.MAX_MODEL_HH_SIZE,
