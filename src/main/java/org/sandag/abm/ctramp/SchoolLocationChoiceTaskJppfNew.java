...
public class SchoolLocationChoiceTaskJppfNew extends JPPFTask {
	...
	public SchoolLocationChoiceTaskJppfNew(int taskIndex, int startIndex,
	...
	public void run() {
		...
		// returns one
		// for re-use.
		SchoolLocationChoiceModel dcModel = modelManager
				.getSchoolLocModelObject(taskIndex, iteration, dcSizeObj);
		...
		modelManager.returnSchoolLocModelObject(dcModel, taskIndex, startIndex,
				endIndex);
