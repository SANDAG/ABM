...
public class TripModeChoiceDMU implements Serializable, VariableTable {
	...
	public int getTourModeIsDA() {
		boolean tourModeIsDa = modelStructure.getTourModeIsSov(tour
				.getTourModeChoice());
		return tourModeIsDa ? 1 : 0;
	}

	public int getTourModeIsS2() {
		boolean tourModeIsS2 = modelStructure.getTourModeIsS2(tour
				.getTourModeChoice());
		return tourModeIsS2 ? 1 : 0;
	}

	public int getTourModeIsS3() {
		boolean tourModeIsS3 = modelStructure.getTourModeIsS3(tour
				.getTourModeChoice());
		return tourModeIsS3 ? 1 : 0;
	}

	public int getTourModeIsSchBus() {
		boolean tourModeIsSchBus = modelStructure.getTourModeIsSchoolBus(tour
				.getTourModeChoice());
		return tourModeIsSchBus ? 1 : 0;
	}

	public int getTourModeIsWalk() {
		boolean tourModeIsWalk = modelStructure.getTourModeIsWalk(tour
				.getTourModeChoice());
		return tourModeIsWalk ? 1 : 0;
	}

	public int getTourModeIsBike() {
		boolean tourModeIsBike = modelStructure.getTourModeIsBike(tour
				.getTourModeChoice());
		return tourModeIsBike ? 1 : 0;
	}

	public int getTourModeIsWTran() {
		boolean tourModeIsWTran = modelStructure.getTourModeIsWalkLocal(tour
				.getTourModeChoice())
				|| modelStructure.getTourModeIsWalkPremium(tour
						.getTourModeChoice());
		return tourModeIsWTran ? 1 : 0;
	}

	public int getTourModeIsPnr() {
		boolean tourModeIsPnr = modelStructure.getTourModeIsPnr(tour
				.getTourModeChoice());
		return tourModeIsPnr ? 1 : 0;
	}

	public int getTourModeIsKnr() {
		boolean tourModeIsKnr = modelStructure.getTourModeIsKnr(tour
				.getTourModeChoice());
