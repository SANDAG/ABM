...
public class DestChoiceTwoStageSoaTazDistanceUtilityDMU implements
		Serializable, VariableTable {

	protected transient Logger logger = Logger
			.getLogger(DestChoiceTwoStageSoaTazDistanceUtilityDMU.class);
