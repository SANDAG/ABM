...
public class SchoolLocationChoiceTaskJppf extends JPPFTask {
	...
	public SchoolLocationChoiceTaskJppf(int taskIndex, int startIndex,
	...
	public void run() {
		...
		// returns one
		// for re-use.
		MandatoryDestChoiceModel dcModel = modelManager.getDcSchoolModelObject(
				taskIndex, iteration, dcSizeObj);
		...
		modelManager.returnDcSchoolModelObject(dcModel, taskIndex, startIndex,
				endIndex);
