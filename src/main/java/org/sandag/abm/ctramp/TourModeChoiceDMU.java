        ...
        implements Serializable, VariableTable
{
    ...
    {
        logger = aLogger;
        if (logger == null) logger = Logger.getLogger(TourModeChoiceDMU.class);
    ...
    protected double getTransitSkimFromMethodName(String methodName) throws Exception
    {
        ...
        else if (part1.equalsIgnoreCase("WTD")) var1 = WTD;
        else if (part1.equalsIgnoreCase("DTW")) var1 = DTW;
        ...
        if (part4.equalsIgnoreCase("OUT")) var4 = OUT;
        else if (part4.equalsIgnoreCase("IN")) var4 = IN;
        else throw new Exception("Fourth part of getTransitSkim is invalid with variable " + var1);
