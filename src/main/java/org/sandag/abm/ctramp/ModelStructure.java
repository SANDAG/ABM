        ...
        implements Serializable
{
    ...
    /**
     * Assume name of the columns in the destination size coefficients file that contain the purpose strings is "purpose" and the column that contains
    ...
    /**
     * @return the HashMap<String,Integer> object that maps primary tour purpose names common to all CTRAMP implementations to indices (1-10).
     */
    ...
    /**
     * @return the HashMap<Integer,String> object that maps indices (1-10) to primary tour purpose names common to all CTRAMP implementations.
     */
    ...
    /**
     * @param purposeKey
     *            is the "purpose" name used as a key for the map to get the associated UEC tab number.
    ...
    /**
     * @param departPeriod
     *            is the model TOD interval for the departure period (for tour or trip)
     ...
     * @param departPeriod
     *            is the model TOD interval for the departure period (for tour or trip)
     * @return the model period index associated with the departure interval Model periods: 0=EA, 1=AM, 2=MD, 3=PM, 4=EV
     */
