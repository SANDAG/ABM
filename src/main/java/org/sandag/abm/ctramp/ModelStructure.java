...
public abstract class ModelStructure implements Serializable {
	...
	public static final int[] SKIM_PERIOD_INDICES = { EA_SKIM_PERIOD_INDEX,
			AM_SKIM_PERIOD_INDEX, MD_SKIM_PERIOD_INDEX, PM_SKIM_PERIOD_INDEX,
			EV_SKIM_PERIOD_INDEX };

	public static final String[] SKIM_PERIOD_STRINGS = { "EA", "AM", "MD",
			"PM", "EV" };
	...
	// combination indices
	public static final int[] SKIM_PERIOD_COMBINATION_INDICES = { EA_EA, EA_AM,
			EA_MD, EA_PM, EA_EV, AM_AM, AM_MD, AM_PM, AM_EV, MD_MD, MD_PM,
			MD_EV, PM_PM, PM_EV, EV_EV };
	...
	public static final String[] MODEL_PERIOD_LABELS = { "EA", "AM", "MD",
			"PM", "EV" };
	...
	abstract public int getSkimPeriodCombinationIndex(int startPeriod,
			int endPeriod);
	...
	private void createPrimaryPurposeMappings() {
		...
		primaryTourPurposeNameIndexMap.put(WORK_PRIMARY_PURPOSE_NAME,
				WORK_PRIMARY_PURPOSE_INDEX);
		indexPrimaryTourPurposeNameMap.put(WORK_PRIMARY_PURPOSE_INDEX,
				WORK_PRIMARY_PURPOSE_NAME);
	...
	public String[] getDcModelPurposeList(String tourCategory) {
		if (tourCategory.equalsIgnoreCase(MANDATORY_CATEGORY))
			...
			return jointDcModelPurposeNames;
				...
				.equalsIgnoreCase(INDIVIDUAL_NON_MANDATORY_CATEGORY))
