...
public class IndividualMandatoryTourFrequencyDMU implements Serializable,
		VariableTable {
	...
	public int getIncomeHigherThan50k() {
		if (household.getIncome() > 2)
			return (1);
		return (0);
	}

	public int getNonFamilyHousehold() {
		if (household.getIsNonFamilyHousehold() == 1
				|| household.getIsGroupQuarters() == 1)
			return 1;
		else
			return 0;
	}
