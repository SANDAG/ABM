 ...
 */
public class HouseholdDataManagerRmi implements HouseholdDataManagerIf,
		Serializable {
	...
	public void setupHouseholdDataManager(ModelStructure modelStructure,
		...
		Object[] objArray = { modelStructure, inputHouseholdFileName,
				inputPersonFileName };
	...
	public void setSchoolDistrictMappings(
		...
		Object[] objArray = { segmentNameIndexMap, mgraGsDist, mgraHsDist,
				gsDistSegMap, hsDistSegMap };
	...
	public double[] getPercentHhsIncome100Kplus() {
		Object[] objArray = {};
		return (double[]) remote
				.method("getPercentHhsIncome100Kplus", objArray);
	}
	...
	public int[][] getTourPurposePersonsByHomeMgra(String[] purposeList) {
		...
		return (int[][]) remote.method("getTourPurposePersonsByHomeMgra",
				objArray);
	}

	public int[] getIndividualNonMandatoryToursByHomeMgra(String purposeString) {
		Object[] objArray = { purposeString };
		return (int[]) remote.method(
				"getIndividualNonMandatoryToursByHomeMgra", objArray);
	}
