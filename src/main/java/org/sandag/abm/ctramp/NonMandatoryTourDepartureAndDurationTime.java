        ...
        implements Serializable
{
    ...
    /**
     * takes an ArrayList of individual non-mandatory tours creates an array of ArrayLists of tours by purpose
     */
    ...
    /**
     * takes an array of joint non-mandatory tours creates an array of ArrayLists of tours by purpose
     */
    ...
    public static void main(String[] args)
    {
         ...
         * 
         * String uecFileDirectory = propertyMap.get( CtrampApplication.PROPERTIES_UEC_PATH ); String todUecFileName = propertyMap.get(
         * IMTOD_UEC_FILE_TARGET ); todUecFileName = uecFileDirectory + todUecFileName;
         * 
         ...
         * 
         * int[] indices = { 0, 1, 2, 3, 4, 5 }; for (int i : indices ) { int uecIndex = i + 4; File uecFile = new File(todUecFileName);
