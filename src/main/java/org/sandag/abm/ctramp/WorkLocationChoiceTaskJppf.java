...
public class WorkLocationChoiceTaskJppf extends JPPFTask {
	...
	public WorkLocationChoiceTaskJppf(int taskIndex, int startIndex,
	...
	public void run() {
		...
		// returns one
		// for re-use.
		MandatoryDestChoiceModel dcModel = modelManager.getDcWorkModelObject(
		...
		modelManager.returnDcWorkModelObject(dcModel, taskIndex, startIndex,
				endIndex);
