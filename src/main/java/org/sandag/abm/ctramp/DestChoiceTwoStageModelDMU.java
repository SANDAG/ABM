...
public abstract class DestChoiceTwoStageModelDMU implements Serializable,
		VariableTable {

	protected transient Logger logger = Logger
			.getLogger(DestChoiceTwoStageModelDMU.class);
	...
	protected int getWorkTourModeIsSOV() {
		boolean tourModeIsSov = modelStructure.getTourModeIsSov(tour
				.getTourModeChoice());
		if (tourModeIsSov)
			return 1;
		else
