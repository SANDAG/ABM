        ...
        implements Serializable, VariableTable
{
    ...
    /**
     * set the value for the number of unique alternatives in the sample. sampleArray can be indexed as i=1; i <= numberInSample. sampleArray.length -
     * 1 is the maximum number of locations in the sample.
     * 
     * @param num
     ...
     * 
     * @param sample
     *            - the sample array of MGRA location choice alternatives. - use numberInSample as upperbound of relevant choices in sample
     */
