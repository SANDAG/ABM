        ...
        implements Serializable
{
    ...
    /**
     * Set the dmu attributes, compute the pre-AO or AO utilities, and select an alternative
     * 
     * @param hhObj
     *            for which to apply thye model
     * @param preAutoOwnership
     *            is true if running pre-auto ownership, or false to run primary auto ownership model.
     */
