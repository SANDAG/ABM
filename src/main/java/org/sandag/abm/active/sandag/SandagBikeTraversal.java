...
public class SandagBikeTraversal
        extends SimpleTraversal<SandagBikeEdge>
{
    public volatile TurnType turnType;
    public volatile double   cost;
    public volatile boolean  thruCentroid, signalExclRightAndThruJunction, unsigLeftFromMajorArt,
            unsigLeftFromMinorArt, unsigCrossMajorArt, unsigCrossMinorArt;
