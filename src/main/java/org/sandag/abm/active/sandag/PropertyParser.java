...
public class PropertyParser
{
    ...
    public Map<String, String> mapStringPropertyListToStrings(String keyProperty,
            String stringValueProperty)
    {
    ...
    public Map<String, Float> mapStringPropertyListToFloats(String keyProperty,
            String stringValueProperty)
    {
