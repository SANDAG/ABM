...
public class BasicShortestPathResultSet<N extends Node>
        extends AbstractShortestPathResultSet<N>
{
    private final Map<NodePair<N>, ShortestPathResult<N>> results;

    public BasicShortestPathResultSet()
    {
        results = new HashMap<>(); // iteration order may not matter, but just
                                   // in case, this is cheap
    }
