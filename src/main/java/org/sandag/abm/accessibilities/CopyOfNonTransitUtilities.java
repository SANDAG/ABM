 ...
 * @version May, 2009
 */
public class CopyOfNonTransitUtilities implements Serializable {

	protected transient Logger logger = Logger
			.getLogger(CopyOfNonTransitUtilities.class);
	...
	public static void main(String[] args) {
		...
		CopyOfNonTransitUtilities au = new CopyOfNonTransitUtilities(rbMap);
		au.buildUtilities();
