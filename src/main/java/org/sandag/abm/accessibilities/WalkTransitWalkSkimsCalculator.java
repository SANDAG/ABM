            ...
            int origTap, int destTap, int departPeriod, boolean debug)
    {
        ...
        if (Modes.getIsPremiumTransit(rideModeIndex))
        {
            ...
            try {
            	...
            	logger.info("PREM walkTransitWalk, departPeriod="+departPeriod+" origTap="+origTap+" destTap="+destTap+" pWalkTime="+pWalkTime);
            }
            ...
            try {
            	...
            	logger.info("PREM walkTransitWalk, departPeriod="+departPeriod+" origTap="+origTap+" destTap="+destTap+" aWalkTime="+aWalkTime);
            }
        ...
        } else
        {
            ...
            try {
            	...
            	logger.info("LOC walkTransitWalk, departPeriod="+departPeriod+" origTap="+origTap+" destTap="+destTap+" pWalkTime="+pWalkTime);
            }
            ...
            try {
            	...
            	logger.info("LOC walkTransitWalk, departPeriod="+departPeriod+" origTap="+origTap+" destTap="+destTap+" aWalkTime="+aWalkTime);
            }
