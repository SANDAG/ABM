        ...
        implements Serializable
{
     ...
     *         <Modes>.
     */
    public synchronized void setUtilitiesForTapPair(int accEgr, int period, int pTap, int aTap, boolean myTrace,
            Logger myLogger)
    {
        ...
        if (storedDepartPeriodTapTapUtils[accEgr][period][pTap][aTap] == null)
        {
            ...
            if (results == null)
            {
                ...
                logger.error("accEgr=" + accEgr + ",period=" + period + ",pTap=" + pTap + ",aTap="
                        + aTap, e);
                throw e;
            }
