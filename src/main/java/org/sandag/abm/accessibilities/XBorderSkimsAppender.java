...
public final class XBorderSkimsAppender
{
    ...
    private String[] inputFormats = { "NUMBER", "NUMBER", "NUMBER", "STRING", "NUMBER", "NUMBER", "STRING" };
    ...
    private void runSkimsAppender(ResourceBundle rb)
    {
        ...
        String outputFileNameHis = Util.getStringValueFromPropertyMap(rbMap, APPENDED_SKIMS_FILE_KEY);
...
//        int[][] hisOdts = { { debugOrigMgra, debugDestMgra, departModelPeriod, 0 } };
            ...
            Logger[] loggers)
    {
        ...
        outStream.print(String.format("%d,%d,%d,%s", sequence, odt[0], odt[1], SKIM_PERIOD_LABELS[odt[2]-1]));
    ...
    private TableDataSet getInputTableDataSet(HashMap<String, String> rbMap)
    {
        ...
        if (hisFileName == null)
        {
            ...
            logger.error("Please specify a filename value for the " + MGRA_O_D_RECORDS_FILE_KEY + " property.");
            throw new RuntimeException();
        }
        ...
        } catch (Exception e)
        {
            logger.fatal(String.format(
                "Exception occurred reading Sandag XBorder MGRA List data records file: %s into TableDataSet object.",
                hisFileName));
            throw new RuntimeException(e);
        }
