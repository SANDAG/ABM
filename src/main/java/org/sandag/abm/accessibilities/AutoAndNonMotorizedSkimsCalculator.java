...
//        distances = new double[mgraManager.getMaxMgra()+1];
    ...
    {                                                                                                                            
        ...
        {                                                                                                                        
            ...
            logger.info("origTaz = " + oTaz + ", destTaz = " + dTaz + ", period = " + departPeriod + ", od distance = "                                         
...
/*                                 
            ...
            boolean debug, Logger logger)
    {
        ...
        // get the DA NT OP distance value for the mgra pair
        double[] autoSkims = autoSkimUECs[OP].solve(iv, dmu, null);
        double distance = autoSkims[2];

        nmSkims[WALK_INDEX] = (distance / WALK_SPEED) * 60.0;
        nmSkims[BIKE_INDEX] = (distance / BIKE_SPEED) * 60.0;
...
/*    
    ...
    {                                                                                                                            
        ...
        {                                                                                                                        
            ...
            int oTaz = mgraManager.getTaz(wMgra);                                                                                
            distances[wMgra] = storedToTazDistanceSkims[OP][dTaz][oTaz];                                                         
...
/*    
    ...
    {                                                                                                                            
        ...
        {                                                                                                                        
            ...
            distances[i] = storedFromTazDistanceSkims[OP][oTaz][dTaz];                                                           
...
*/                                                                                                                                 
    ...
    public double[] getOpSkimDistancesFromMgra(int oMgra)
    {
        ...
        for (int i = 1; i <= mgraManager.getMaxMgra(); i++)
        {
            ...
            // sov distance
            double[] autoResults = autoSkimUECs[OP].solve(iv, dmu, null);
            distances[i] = autoResults[2];
    ...
    */
    ...
    /**
     * Calculate utility expressions for auto skims for a given origin to
     * get distances to all destination mgras, and return am peak sov distance.
     * 
     * @param oMgra The origin mgra
     * @return An array of am peak sov distances
    public double[] getAmPkSkimDistancesFromMgra(int oMgra)
    {
        ...
        for (int i = 1; i <= mgraManager.getMaxMgra(); i++)
        {
            ...
            // sov distance
            double[] autoResults = autoSkimUECs[AM].solve(iv, dmu, null);
            distances[i] = autoResults[2];
