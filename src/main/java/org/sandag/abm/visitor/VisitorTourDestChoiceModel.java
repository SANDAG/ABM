...
public class VisitorTourDestChoiceModel
{
    ...
    /**
     * Use the tour mode choice model to calculate the logsum for each sampled mgra and store in the array.
     * 
     * @param tour
     *            The visitor tour.
     */
     ...
     * 
     * @param tour
     *            A cross border tour with a tour origin, purpose, attributes, and departure\arrival time and SENTRI availability members.
     */
