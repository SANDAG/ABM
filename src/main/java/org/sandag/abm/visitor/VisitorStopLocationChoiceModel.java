...
public class VisitorStopLocationChoiceModel
{
    ...
    private TableDataSet                 alternativeData;                          // the alternatives, with a "dest" - indicating the destination
                                                                                    // TAZ in San Diego County
    ...
    private int                          originMgra;                               // the origin MGRA of the stop (originMgra -> stopMgra ->
                                                                                    // destinationMgra)
    private int                          destinationMgra;                          // the destination MGRA of the stop (originMgra -> stopMgra ->
                                                                                    // destinationMgra)
