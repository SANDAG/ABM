...
public class VisitorTourManager {
	...
	public void generateVisitorTours(){
        ...
        for(int i =1;i<=rows;++i){
        	...
        	personalParties += Math.round(householdVisitorParties * (1.0f-businessHouseholdPercent));
	 ...
	 * 
	 * @param tourFrequency A tableDataSet with the following fields WorkTours,RecreationTours,DiningTours,Percent
