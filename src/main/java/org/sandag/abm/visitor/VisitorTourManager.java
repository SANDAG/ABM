...
public class VisitorTourManager
{
    ...
    /**
     * Calculate the number of tours for this travel party, by purpose. Return an array whose length equals the number of tours, where each element is
     * the purpose of the tour.
     * 
     * @param tourFrequency
     *            A tableDataSet with the following fields WorkTours,RecreationTours,DiningTours,Percent
