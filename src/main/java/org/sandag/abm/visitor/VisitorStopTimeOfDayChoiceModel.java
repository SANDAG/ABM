...
/**
 * This class is the TOD choice model for visitor tours. It is currently based on a static probability distribution stored in an input file, and
...
public class VisitorStopTimeOfDayChoiceModel
{
    ...
    private HashMap<Integer, Integer> outboundElementMap;                       // Hashmap used to get the element number of the cumProbability array
                                                                                 // based on the
    // tour duration and stop number.

    private HashMap<Integer, Integer> inboundElementMap;                        // Hashmap used to get the element number of the cumProbability array
                                                                                 // based on the
