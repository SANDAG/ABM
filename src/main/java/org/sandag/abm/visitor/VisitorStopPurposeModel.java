...
/**
 * This class is the stop purpose choice model for visitor tours. It is currently based on a static probability distribution stored in an input file,
 * and indexed into by purpose, tour leg direction (inbound or outbound), the stop number, and whether there is just one or multiple stops on the tour
 * leg.
 * 
 * @author Freedman
 * 
...
public class VisitorStopPurposeModel
{
    ...
    HashMap<Integer, Integer> arrayElementMap;                          // Hashmap used to get the element number of the cumProbability array based
                                                                         // on the
