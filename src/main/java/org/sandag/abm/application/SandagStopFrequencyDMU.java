...
public class SandagStopFrequencyDMU extends StopFrequencyDMU {
	...
	private void setupModelIndexMappings() {
		...
		tourPurposeModelSheetMap.put(ModelStructure.WORK_PRIMARY_PURPOSE_INDEX,
				WORK_MODEL_SHEET);
		tourPurposeModelSheetMap.put(
				ModelStructure.UNIVERSITY_PRIMARY_PURPOSE_INDEX,
				UNIVERSITY_MODEL_SHEET);
		tourPurposeModelSheetMap
				.put(ModelStructure.SCHOOL_PRIMARY_PURPOSE_INDEX,
						SCHOOL_MODEL_SHEET);
		tourPurposeModelSheetMap
				.put(ModelStructure.ESCORT_PRIMARY_PURPOSE_INDEX,
						ESCORT_MODEL_SHEET);
		tourPurposeModelSheetMap.put(
				ModelStructure.SHOPPING_PRIMARY_PURPOSE_INDEX,
				SHOPPING_MODEL_SHEET);
		tourPurposeModelSheetMap.put(
				ModelStructure.OTH_MAINT_PRIMARY_PURPOSE_INDEX,
				MAINT_MODEL_SHEET);
		tourPurposeModelSheetMap.put(
				ModelStructure.EAT_OUT_PRIMARY_PURPOSE_INDEX,
				EAT_OUT_MODEL_SHEET);
		tourPurposeModelSheetMap.put(
				ModelStructure.VISITING_PRIMARY_PURPOSE_INDEX,
				VISITING_MODEL_SHEET);
		tourPurposeModelSheetMap.put(
				ModelStructure.OTH_DISCR_PRIMARY_PURPOSE_INDEX,
				DISCR_MODEL_SHEET);
		tourPurposeModelSheetMap.put(
