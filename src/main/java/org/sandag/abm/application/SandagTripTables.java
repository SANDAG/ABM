...
public class SandagTripTables
{
    ...
    private int[]                   matrixIndex;                                                    // an index array, dimensioned by number of
                                                                                                     // modes, returns the element of the matrix array
                                                                                                     // to store value
    ...
    private HashMap<String, Float>  averageOcc3Plus;                                                // a HashMap of average occupancies for 3+
     ...
     * 
     * @param rbMap
     *            HashMap formed from a property map, which includes environment variables and arguments passed in as -d to VM
     * @param sampleRate
     *            Sample rate 0->1.0
     * @param iteration
     *            Iteration number, program will look for trip file names with _iteration appended
     */
     ...
     * 
     * @param sampleRate
     *            The iteration number, should be appended to trip files as _iteration
     */
    ...
    /**
     * Helper method for establishing connection to the matrix server. If "none" was specified, default server is started on localhost. Otherwise, a
     * server at the IP address and port specified is assumed to be running, and this code will start the server and stop it when finished.
     * 
     * @param pMap
