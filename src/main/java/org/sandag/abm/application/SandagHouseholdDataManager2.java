        ...
        extends HouseholdDataManager
{
        ...
        for (int i = 0; i < numHouseholdsInSample; i++)
        {
            ...
            try
            {
                ...
                for (p = personHhStart[hhid]; p <= personHhEnd[hhid]; p++)
                {
                    ...
                    fieldCount++;
                    /*
                     * int occcen1 = (int) personTable.getValueAt(p, personTable.getColumnPosition(PERSON_SOC_FIELD_NAME)); int pecasOccup =
                     * occCodes[occcen1];
                     */
                    ...
                    pecasOccup = 56;
                            ...
                            && indcen <= militaryIndustryHigh) // not active military but military contractor
                    pecasOccup = 56;
                    else
                    {
                    ...
                    /*
                     * These are the old codes, based upon census occupation definitions if ((pecasOccup == 71) && (activityCode == 2 || activityCode
                     * == 4 || activityCode == 6 || activityCode == 8 || activityCode == 29)) activityCode++;
                     * 
                     * if ((pecasOccup == 76) && (activityCode == 3 || activityCode == 5 || activityCode == 7 || activityCode == 9 || activityCode ==
                     * 30)) activityCode--;
                     * 
                    ...
                    // recode PEMPLOY to 3 for persons whose age is 16 or greater and who have PEMPLOY set to 4
    ...
    /**
     * This method reads a cross-walk file between the occsoc code in Census and the PECAS occupation categories. It stores the result in a HashMap
     * and returns it.
     * 
     * @return
     */
