        ...
        implements Serializable
{
    ...
    private void calculateMgraAvgParkingCosts( HashMap<String,String> propertyMap ) {
        ...
        if ( LOG_MGRA > 0 ) {
            try {
                outM = new PrintWriter( new BufferedWriter( new FileWriter( new File( projectPath + "output/" + LOG_MGRA_FILE + "M.csv" ) ) ) );
                outD = new PrintWriter( new BufferedWriter( new FileWriter( new File( projectPath + "output/" + LOG_MGRA_FILE + "D.csv" ) ) ) );
                outH = new PrintWriter( new BufferedWriter( new FileWriter( new File( projectPath + "output/" + LOG_MGRA_FILE + "H.csv" ) ) ) );
            }
            catch (IOException e) {
