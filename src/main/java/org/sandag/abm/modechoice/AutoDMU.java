 ...
 */
public class AutoDMU implements Serializable, VariableTable {
	...
	public void logValues(Logger localLogger) {
		...
		localLogger.info("");
		localLogger.info(String.format(
				"Average TAZ Parking cost at destination:     %9f",
				avgHourlyParkingCostAtDestTaz));
		localLogger.info(String.format(
				"Production/Origin Terminal Time: %9.4f", pTazTerminalTime));
		localLogger.info(String.format(
				"Attraction/Destin Terminal Time: %9.4f", aTazTerminalTime));
