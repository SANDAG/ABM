 ...
 */
public class NonMotorUEC implements Serializable {
	 ...
	 * @param dataSheet
	 */
	public NonMotorUEC(HashMap<String, String> rbHashMap, String uecFileName,
	...
	public double calculateUtilitiesForMgraPair(int oMgra, int dMgra) {
		...
		// log DMU values
		if (trace) {
			logger.info("MGRA-MGRA non-motorized calculations for " + oMgra
					+ " to " + dMgra);
			dmu.logValues(logger);
		}
