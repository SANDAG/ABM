...
public class McLogsumsCalculator implements Serializable
{
     ...
     * @param mcDmuObject
     */
     public void setTripMcDmuSkimAttributes( InternalExternalTour tour, InternalExternalTrip trip, InternalExternalTripModeChoiceDMU mcDmuObject)
     {
    ...
    private void setNmTripMcDmuAttributes( InternalExternalTripModeChoiceDMU tripMcDmuObject, int origMgra, int destMgra, int departPeriod, boolean loggingEnabled )
    {
    ...
    private void setWtwTripMcDmuAttributes( InternalExternalTripModeChoiceDMU tripMcDmuObject, int origMgra, int destMgra, int departPeriod, int[][] bestTapPairs, boolean loggingEnabled)
    {
    ...
    private void setWtdTripMcDmuAttributes( InternalExternalTripModeChoiceDMU tripMcDmuObject, int origMgra, int destMgra, int departPeriod, int[][] bestTapPairs, boolean loggingEnabled )
    {
    ...
    private void setDtwTripMcDmuAttributes( InternalExternalTripModeChoiceDMU tripMcDmuObject, int origMgra, int destMgra, int departPeriod, int[][] bestTapPairs, boolean loggingEnabled )
    {
