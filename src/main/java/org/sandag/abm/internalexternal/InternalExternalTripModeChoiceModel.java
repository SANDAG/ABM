...
public class InternalExternalTripModeChoiceModel {
	 ...
	 */
	public InternalExternalTripModeChoiceModel(
	 ...
	 * @param trip
	 */
	public double computeUtilities(InternalExternalTour tour,
	 ...
	 * @param trip
	 */
	public void setDmuAttributes(InternalExternalTour tour,
			InternalExternalTrip trip) {
