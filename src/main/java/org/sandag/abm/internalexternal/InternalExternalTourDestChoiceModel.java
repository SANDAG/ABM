...
public class InternalExternalTourDestChoiceModel {
     ...
     */
	public InternalExternalTourDestChoiceModel(HashMap<String,String> rbMap, InternalExternalModelStructure modelStructure, InternalExternalDmuFactoryIf dmuFactory){
        ...
        String internalExternalDCFileName = Util.getStringValueFromPropertyMap(rbMap, "internalExternal.dc.uec.file");
        internalExternalDCFileName = uecFileDirectory + internalExternalDCFileName;
       	int dataPage = Util.getIntegerValueFromPropertyMap(rbMap, "internalExternal.dc.uec.data.page");
        int destModelPage = Util.getIntegerValueFromPropertyMap(rbMap, "internalExternal.dc.uec.model.page");
        destModel = new ChoiceModelApplication( internalExternalDCFileName, destModelPage, dataPage, rbMap, (VariableTable)dcDmu );
	 ...
	 * 
	 * @param tour An IE tour with a tour origin.
	 */
