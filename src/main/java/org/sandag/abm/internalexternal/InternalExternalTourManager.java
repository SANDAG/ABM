...
public class InternalExternalTourManager {
    ...
    public InternalExternalTourManager(HashMap<String,String> rbMap, int iteration){
        ...
        String householdFile = Util.getStringValueFromPropertyMap(rbMap,"Results.HouseholdDataFile");
	...
	public void writeOutputFile(HashMap<String,String> rbMap){
		...
		String directory = Util.getStringValueFromPropertyMap(rbMap,"Project.Directory");
         String tripFileName = directory+Util.getStringValueFromPropertyMap(rbMap,"internalExternal.trip.output.file");
		...
		String tripHeaderString = new String("originMGRA,destinationMGRA,originTAZ,destinationTAZ,inbound,originIsTourDestination,destinationIsTourDestination,period,tripMode,boardingTap,alightingTap\n");
