...
public class InternalExternalTripTables {
	...
	public void createTripTables(MatrixType mt){
		...
		String tripFile = Util.getStringValueFromPropertyMap(rbMap,"internalExternal.trip.output.file");
	...
	public void writeTrips(int period, MatrixType mt){
		...
		fileName[0] =directory+Util.getStringValueFromPropertyMap(rbMap,"internalExternal.results.autoTripMatrix")+end;
		fileName[1] =directory+Util.getStringValueFromPropertyMap(rbMap,"internalExternal.results.nMotTripMatrix")+end;
		fileName[2] =directory+Util.getStringValueFromPropertyMap(rbMap,"internalExternal.results.tranTripMatrix")+end; 
		fileName[3] =directory+Util.getStringValueFromPropertyMap(rbMap,"internalExternal.results.othrTripMatrix")+end; 
