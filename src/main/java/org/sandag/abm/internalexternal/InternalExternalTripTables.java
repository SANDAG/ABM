...
public class InternalExternalTripTables {
	...
	public static void main(String[] args) {
		...
		logger.info(String
				.format("SANDAG Visitor Model Trip Table Generation Program using CT-RAMP version %s",
		...
		InternalExternalTripTables tripTables = new InternalExternalTripTables(
				pMap);
		...
		if (matrixServerAddress.equalsIgnoreCase("localhost")) {
			...
			if (!matrixServerAddress.equalsIgnoreCase("none"))
				tripTables.ms
						.stop32BitMatrixIoServer("InternalExternalTripTables");
		}
	}
