...
public class InternalExternalTrip implements Serializable{
     ...
     */
    public InternalExternalTrip(InternalExternalTour tour, boolean outbound, MgraDataManager mgraManager){
     ...
     * @param outbound  Outbound direction.
     */
    public void initializeFromTour(InternalExternalTour tour, boolean outbound, MgraDataManager mgraManager){
