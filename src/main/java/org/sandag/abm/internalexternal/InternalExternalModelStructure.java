...
public class InternalExternalModelStructure extends SandagModelStructure {

	public final static byte NUMBER_VISITOR_PURPOSES = 6;
	public final static byte WORK = 0;
	public final static byte RECREATION = 1;
	public final static byte DINING = 2;

	public final static String[] VISITOR_PURPOSES = { "WORK", "RECREATE",
			"DINING" };
