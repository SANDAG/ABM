...
public class AirportModel {
	...
	public void runModel() {
		...
		AirportDestChoiceModel destChoiceModel = new AirportDestChoiceModel(
				rbMap, dmuFactory);
		...
		AirportModeChoiceModel modeChoiceModel = new AirportModeChoiceModel(
				rbMap, dmuFactory);
