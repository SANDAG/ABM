...
public class AirportModelStructure {
	
	public final static byte PURPOSES = 5;
	public final static byte RESIDENT_BUSINESS = 0;
	public final static byte RESIDENT_PERSONAL = 1;
	public final static byte VISITOR_BUSINESS  = 2;
	public final static byte VISITOR_PERSONAL  = 3;
	public final static byte EXTERNAL          = 4;
	
	public final static byte INTERNAL_PURPOSES = 4;
	
	public final static byte DEPARTURE = 0;
	public final static byte ARRIVAL = 1;

	public final static byte INCOME_SEGMENTS = 8;
	public final static byte DC_SIZE_SEGMENTS  = INCOME_SEGMENTS * 2 + 2;
	 ...
	 * @param purpose
	 * @param income
	 * @return  The dc size term segment, currently 0-17, where:
	 *    0-7 are 8 income groups for RES_BUS
	 *    8-15 are 8 income groups for RES_PER
	 *    16 is VIS_BUS
	 *    17 is VIS_PER
	 */
     ...
     *  
     * @param accessMode  Access mode, 1-based, consistent with definitions above.
     * @param partySize   Number of passengers in travel party
	...
	public static int getOccupancy(int accessMode, int partySize){
        ...
        default:
            throw new RuntimeException("Error:  AccessMode not found in AirportModel.AirportModelStructure");
