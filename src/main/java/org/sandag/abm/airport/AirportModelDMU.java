	...
	implements Serializable, VariableTable
{
	...
	private double[][] sizeTerms;  //dimensioned by segment, taz 
	private int[] zips; //dimensioned by taz 
    ...
    protected static final int[] DEFAULT_DEPART_INDICES = { -1, EA_D, AM_D, MD_D, PM_D, EV_D };
    ...
    protected static final int[] DEFAULT_ARRIVE_INDICES = { -1, EA_A, AM_A, MD_A, PM_A, EV_A };
    
    protected String[][] departArriveCombinationLabels = {
            {"EA", "EA" },
            {"EA", "AM" },
            {"EA", "MD" },
            {"EA", "PM" },
    ...
    protected int[][] departArriveCombinations = {
            { EA, EA },
            { EA, AM },
            { EA, MD },
            { EA, PM },
	...
	/**
	 * Set up the method index hashmap, where the key is the getter method for a data item 
		...
		switch (variableIndex)
	    {
            ...
            case 150:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, LB, LB_IVT);
                else
                    return getTransitSkim(WTD, LB, LB_IVT);
                
            case 151:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, LB, FWAIT);
                else
                    return getTransitSkim(WTD, LB, FWAIT);
                
            case 152:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, LB, XWAIT);
                else
                    return getTransitSkim(WTD, LB, XWAIT);
                
            case 153:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return 0;
                else
                    return getTransitSkim(WTD, LB, ACC);
                
            case 154:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, LB, EGR);
                else
                    return 0;
                
            case 155:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, LB, ACC);
                else
                    return getTransitSkim(WTD, LB, EGR);
                
            case 156:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, LB, AUX);
                else
                    return getTransitSkim(WTD, LB, AUX);
                
            case 157:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, LB, FARE);
                else
                    return getTransitSkim(WTD, LB, FARE);
                
            case 158:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, LB, XFERS);
                else
                    return getTransitSkim(WTD, LB, XFERS);
                
            case 159:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, EB, LB_IVT);
                else
                    return getTransitSkim(WTD, EB, LB_IVT);
                
            case 160:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, EB, EB_IVT);
                else
                    return getTransitSkim(WTD, EB, EB_IVT);
                
            case 161:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, EB, FWAIT);
                else
                    return getTransitSkim(WTD, EB, FWAIT);
                
            case 162:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, EB, XWAIT);
                else
                    return getTransitSkim(WTD, EB, XWAIT);
                
            case 163:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return 0;
                else
                    return getTransitSkim(WTD, EB, ACC);
                
            case 164:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, EB, EGR);
                else
                    return 0;
                
            case 165:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, EB, ACC);
                else
                    return getTransitSkim(WTD, EB, EGR);
                
            case 166:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, EB, AUX);
                else
                    return getTransitSkim(WTD, EB, AUX);
                
            case 167:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, EB, FARE);
                else
                    return getTransitSkim(WTD, EB, FARE);
                
            case 168:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, EB, XFERS);
                else
                    return getTransitSkim(WTD, EB, XFERS);
                
            case 169:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, BRT, LB_IVT);
                else
                    return getTransitSkim(WTD, BRT, LB_IVT);
                
            case 170:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, BRT, EB_IVT);
                else
                    return getTransitSkim(WTD, BRT, EB_IVT);
                
            case 171:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, BRT, BRT_IVT);
                else
                    return getTransitSkim(WTD, BRT, BRT_IVT);
                
            case 172:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, BRT, FWAIT);
                else
                    return getTransitSkim(WTD, BRT, FWAIT);
                
            case 173:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, BRT, XWAIT);
                else
                    return getTransitSkim(WTD, BRT, XWAIT);
                
            case 174:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return 0;
                else
                    return getTransitSkim(WTD, BRT, ACC);
                
            case 175:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, BRT, EGR);
                else
                    return 0;
                
            case 176:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, BRT, ACC);
                else
                    return getTransitSkim(WTD, BRT, EGR);
                
            case 177:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, BRT, AUX);
                else
                    return getTransitSkim(WTD, BRT, AUX);
                
            case 178:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, BRT, FARE);
                else
                    return getTransitSkim(WTD, BRT, FARE);
                
            case 179:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, BRT, XFERS);
                else
                    return getTransitSkim(WTD, BRT, XFERS);
                
            case 180:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, LR, LB_IVT);
                else
                    return getTransitSkim(WTD, LR, LB_IVT);
                
            case 181:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, LR, EB_IVT);
                else
                    return getTransitSkim(WTD, LR, EB_IVT);
                
            case 182:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, LR, BRT_IVT);
                else
                    return getTransitSkim(WTD, LR, BRT_IVT);
                
            case 183:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, LR, LR_IVT);
                else
                    return getTransitSkim(WTD, LR, LR_IVT);
                
            case 184:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, LR, FWAIT);
                else
                    return getTransitSkim(WTD, LR, FWAIT);
                
            case 185:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, LR, XWAIT);
                else
                    return getTransitSkim(WTD, LR, XWAIT);
                
            case 186:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return 0;
                else
                    return getTransitSkim(WTD, LR, ACC);
                
            case 187:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, LR, EGR);
                else
                    return 0;
                
            case 188:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, LR, ACC);
                else
                    return getTransitSkim(WTD, LR, EGR);
                
            case 189:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, LR, AUX);
                else
                    return getTransitSkim(WTD, LR, AUX);
                
            case 190:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, LR, FARE);
                else
                    return getTransitSkim(WTD, LR, FARE);
                
            case 191:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, LR, XFERS);
                else
                    return getTransitSkim(WTD, LR, XFERS);
                
            case 192:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, CR, LB_IVT);
                else
                    return getTransitSkim(WTD, CR, LB_IVT);
                
            case 193:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, CR, EB_IVT);
                else
                    return getTransitSkim(WTD, CR, EB_IVT);
                
            case 194:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, CR, BRT_IVT);
                else
                    return getTransitSkim(WTD, CR, BRT_IVT);
                
            case 195:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, CR, LR_IVT);
                else
                    return getTransitSkim(WTD, CR, LR_IVT);
                
            case 196:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, CR, CR_IVT);
                else
                    return getTransitSkim(WTD, CR, CR_IVT);
                
            case 197:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, CR, FWAIT);
                else
                    return getTransitSkim(WTD, CR, FWAIT);
                
            case 198:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, CR, XWAIT);
                else
                    return getTransitSkim(WTD, CR, XWAIT);
                
            case 199:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return 0;
                else
                    return getTransitSkim(WTD, CR, ACC);
                
            case 200:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, CR, EGR);
                else
                    return 0;
                
            case 201:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, CR, ACC);
                else
                    return getTransitSkim(WTD, CR, EGR);
                
            case 202:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, CR, AUX);
                else
                    return getTransitSkim(WTD, CR, AUX);
                
            case 203:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, CR, FARE);
                else
                    return getTransitSkim(WTD, CR, FARE);
                
            case 204:
                if ( airportParty.getDirection() == AirportModelStructure.DEPARTURE )
                    return getTransitSkim(DTW, CR, XFERS);
                else
                    return getTransitSkim(WTD, CR, XFERS);
     ...
     * 
     * @param myWtw  the WalkTransitWalkSkimsCalculator
     * @param myWtd  the WalkTransitDriveSkimsCalculator
     * @param myDtw  the DriveTransitWalkSkimsCalculator
     */
    public void setDmuSkimCalculators(
            WalkTransitWalkSkimsCalculator myWtw, WalkTransitDriveSkimsCalculator myWtd, DriveTransitWalkSkimsCalculator myDtw)
    {
        wtw = myWtw;
        wtd = myWtd;
        dtw = myDtw;
    ...
    /**
     * Set the transit skim array value for the access/egress mode, line-haul mode, LOS component
     * 
     * @param accEgr       An indicator of whether this is wtw, wtd, or dtw
     * @param lbPrem       The line-haul mode 
     * @param skimIndex    The index for the skim
    ...
    /**
     * Get the value from the transit skim matrix for the access/egress mode, line-haul mode, and LOS component
     * @param accEgr       An indicator of whether this is wtw, wtd, or dtw
     * @param lbPrem       The line-haul mode 
     * @param skimIndex    The index for the skim
    ...
    /**
     * Set the transit skim variables from the skim calculators, based upon the best TAP-TAP pairs for the airport
     * party.  Note that the best TAP-TAP pairs should already be set for each transit access mode (wtw, dtw, and wtd).
     * 
     * @param origMgra  Origin MGRA
     * @param destMgra  Destination MGRA
     * @param departPeriod  Travel Period
     * @param isInbound    Direction flag (true if arriving party, false if departing party)
     * @param debugFlag    Debug flag
     */
    public void setDmuSkimAttributes( int origMgra, int destMgra, int departPeriod, boolean isInbound, boolean debugFlag ) {
        
        boolean debug = false;
        if ( debugFlag )
            debug = airportParty.getDebugChoiceModels();
        ...
        if(!isInbound){
       	...
       	}else{  // return (from airport to origin) sets walk-transit-drive skims
    ...
    /**
     * Sets walk-transit walk skims based upon best tap pairs, origin, destination, and travel period.
     * 
    * @param origMgra        Origin MGRA
     * @param destMgra       Destination MGRA
     * @param departPeriod   Travel Period
     * @param bestTapPairs   Best TAP-TAP walk-transit pairs.
     * @param loggingEnabled True to debug
     */
    protected void setWtwDmuAttributes(int origMgra, int destMgra, int departPeriod, int[][] bestTapPairs, boolean loggingEnabled)
    {
    ...
    /**
     * Sets walk-transit-drive skims based upon best tap pairs, origin, destination, and travel period.
     * 
     * @param origMgra        Origin MGRA
     * @param destMgra       Destination MGRA
     * @param departPeriod   Travel Period
     * @param bestTapPairs   Best TAP-TAP walk-transit-drive pairs.
     * @param loggingEnabled True to debug
     */
    protected void setWtdDmuAttributes(int origMgra, int destMgra, int departPeriod, int[][] bestTapPairs, boolean loggingEnabled)
    {
    ...
    /**
     * Sets drive-transit-walk skims based upon best tap pairs, origin, destination, and travel period.
     * 
     * @param origMgra        Origin MGRA
     * @param destMgra       Destination MGRA
     * @param departPeriod   Travel Period
     * @param bestTapPairs   Best TAP-TAP drive-transit-walk pairs.
     * @param loggingEnabled True to debug
     */
    protected void setDtwDmuAttributes(int origMgra, int destMgra, int departPeriod, int[][] bestTapPairs, boolean loggingEnabled)
    {
        ...
        int skimPeriodIndex = AirportModelStructure.getSkimPeriodIndex(departPeriod);
        departPeriod = skimPeriodIndex + 1;
   //     bestTapPairs = dtw.getBestTapPairs(origMgra, destMgra, departPeriod, loggingEnabled, logger);
	     ...
	     * 
	     * @param tazNumber  the number of the taz
	    ...
	    /**
	     * Set size terms
	     * @param sizeTerms  A double[][] array dimensioned by segments (purp\income groups) and taz numbers
	     */
	    ...
	    /**
	     * set the zip codes
	     * @param zips  int[] dimensioned by taz number
	     */
		...
		/**
		 * @param driveAloneLogsum the driveAloneLogsum to set
		 */
		...
		/**
		 * @param shared2Logsum the shared2Logsum to set
		 */
		...
		/**
		 * @param shared3Logsum the shared3Logsum to set
		 */
		...
		/**
		 * @param transitLogsum the transitLogsum to set
		 */
