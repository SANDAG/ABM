        ...
        implements Serializable, VariableTable
{
    ...
    private double[][]                        sizeTerms;                                                                       // dimensioned by
                                                                                                                                // segment, taz
    ...
    /**
     * Set up the method index hashmap, where the key is the getter method for a data item and the value is the index.
     */
    ...
    /**
     * Set the transit skim variables from the skim calculators, based upon the best TAP-TAP pairs for the airport party. Note that the best TAP-TAP
     * pairs should already be set for each transit access mode (wtw, dtw, and wtd).
     * 
     * @param origMgra
     *            Origin MGRA
     * @param destMgra
     ...
     *            Travel Period
     * @param isInbound
     *            Direction flag (true if arriving party, false if departing party)
     * @param debugFlag
     *            Debug flag
     */
            ...
            boolean isInbound, boolean debugFlag)
    {
        ...
        { // return (from airport to origin) sets walk-transit-drive skims
     ...
     * 
     * @param sizeTerms
     *            A double[][] array dimensioned by segments (purp\income groups) and taz numbers
     */
