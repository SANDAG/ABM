...
public class AirportPartyManager
{
    ...
    /**
     * Create parties based upon total parties (calculated in constructor). Fill parties[] with travel parties, assuming one-half are arriving and
     * one-half are departing. Simulate party characteristics (income, size, duration, time departing from origin or arriving at airport) from
    ...
    /**
     * Read the probabilities in the file, convert to a cumulative probability distribution, initialize the array, and store in the array.
     * 
     * This method is used for files that contain 2-dimensional probabilities by airport purpose and some other dimension, such as income, party size,
     * or departure time.
     * 
     * @param probArray
     ...
     * 
     * @param purpose
     *            The airport model purpose, used to index into probability array.
     * @param probs
     *            A 2-dimensional array of cumulative probabilities, where the first dimension is number of alternative (0-based) and second column is
