...
public class AirportDestChoiceModel
{
    ...
    private double[][]                  tazProbabilities;                         // by segment, origin taz 0-based (note since airport model, only 1
                                                                                   // taz dimension is needed)
    ...
    /**
     * Calculate the zip codes at a taz level from the mgra data file. This requires the mgra data to be specified as mgra.socec.file in the
     * properties file. The mgra file must have four fields: zone, taz, pop, and zip The taz zip is coded based upon the highest population mgra
     * within the taz.
     * 
    ...
    /**
     * Iterate through an array of AirportParty objects, choosing origin MGRAs for each and setting the result back in the objects.
     * 
