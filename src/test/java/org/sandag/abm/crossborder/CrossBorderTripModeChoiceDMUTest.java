...
import org.sandag.abm.airport.AirportModelDMU;
...
public class CrossBorderTripModeChoiceDMUTest {
	...
	public void testGetValueForIndexBasic() {
		...
		int hourlyParkingCostTourDest = 6;
		dmu.setHourlyParkingCostTourDest(hourlyParkingCostTourDest);
		value = dmu.getValueForIndex(14, 0);
		Assert.assertEquals(returnStops, (int) hourlyParkingCostTourDest);
		
		int dailyParkingCostTourDest = 6;
		dmu.setDailyParkingCostTourDest(dailyParkingCostTourDest);
		value = dmu.getValueForIndex(15, 0);
		Assert.assertEquals(returnStops, (int) dailyParkingCostTourDest);
		
		int monthlyParkingCostTourDest = 6;
		dmu.setMonthlyParkingCostTourDest(monthlyParkingCostTourDest);
		value = dmu.getValueForIndex(16, 0);
		Assert.assertEquals(returnStops, (int) monthlyParkingCostTourDest);
		
		int tripOrigIsTourDest = 6;
		dmu.setTripOrigIsTourDest(tripOrigIsTourDest);
		value = dmu.getValueForIndex(17, 0);
		Assert.assertEquals(returnStops, (int) tripOrigIsTourDest);
		
		int tripDestIsTourDest = 6;
		dmu.setTripDestIsTourDest(tripDestIsTourDest);
		value = dmu.getValueForIndex(18, 0);
		Assert.assertEquals(returnStops, (int) tripDestIsTourDest);
		
		int hourlyParkingCostTripOrig = 6;
		...
		int hourlyParkingCostTripDest = 6;
