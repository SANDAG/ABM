...
public class SandagAppendMcLogsumDMUTest
{
    ...
    {
        SandagAppendMcLogsumDMU dmu = new SandagAppendMcLogsumDMU(CreateFakeModelStructure(),
                CreateFakeLogger());
    }
    ...
    public void testGetValueForIndexHousehold()
    {
        ...
        SandagAppendMcLogsumDMU dmu = new SandagAppendMcLogsumDMU(model, CreateFakeLogger());
    ...
    private void TestTazParams(int p1, int p2, int p3, int p4, int i, SandagAppendMcLogsumDMU dmu)
    {
