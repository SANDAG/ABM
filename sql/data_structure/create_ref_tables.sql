...
VALUES	
	...
	(3,'Auto 2 Person (Non-Toll, Non-HOV)', 'HOV 2 Person', 'HOV2'),
	(4,'Auto 2 Person (Non-Toll, HOV)', 'HOV 2 Person', 'HOV2'),
	(5,'Auto 2 Person (Toll, HOV)', 'HOV 2 Person', 'HOV2'),
	(6,'Auto 3+ Person (Non-Toll, Non-HOV)', 'HOV 3+ Person', 'HOV3+'),
	(7,'Auto 3+ Person (Non-Toll, HOV)', 'HOV 3+ Person', 'HOV3+'),
	(8,'Auto 3+ Person (Toll, HOV)', 'HOV 3+ Person', 'HOV3+'),
	(9,'Walk', 'Walk', 'WALK'),
	(10,'Bike', 'Bike', 'BIKE'),
	(11,'Walk-Local Bus', 'Local Bus', 'LOCAL'),
	(12,'Walk-Express Bus', 'Express Bus', 'EXP'),
	(13,'Walk-Bus Rapid Transit', 'Rapid', 'RAPID'),
	(14,'Walk-Light Rail', 'Light Rail', 'LRT'),
	(15,'Walk-Heavy Rail', 'Heavy Rail', 'CR'),
	(16,'PNR-Local Bus', 'Local Bus', 'LOCAL'),
	(17,'PNR-Express Bus', 'Express Bus', 'EXP'),
	(18,'PNR-Bus Rapid Transit', 'Rapid', 'RAPID'),
	(19,'PNR-Light Rail', 'Light Rail', 'LRT'),
	(20,'PNR-Heavy Rail', 'Heavy Rail', 'CR'),
	(21,'KNR-Local Bus', 'Local Bus', 'LOCAL'),
	(22,'KNR-Express Bus', 'Express Bus', 'EXP'),
	(23,'KNR-Bus Rapid Transit', 'Rapid', 'RAPID'),
	(24,'KNR-Light Rail', 'Light Rail', 'LRT'),
	(25,'KNR-Heavy Rail', 'Heavy Rail', 'CR'),
	(26,'School Bus', 'School Bus', 'SBUS'),
	(27,'Taxi', 'Taxi', 'TAXI'),
	(28, 'Cross Border Drive Alone', 'Drive Alone', 'SOV'),
	(29, 'Cross Border Shared 2', 'HOV 2 Person', 'HOV2'),
	(30, 'Cross Border Shared 3', 'HOV 3+ Person', 'HOV3+'),
	(31, 'Cross Border Walk', 'Walk', 'WALK'),
	(32, 'Light Heavy Duty Truck (Non-Toll)', 'Light Heavy Duty Truck', 'LHDT'),
	(33, 'Light Heavy Duty Truck (Toll)', 'Light Heavy Duty Truck', 'LHDT'),
	(34, 'Medium Heavy Duty Truck (Non-Toll)', 'Medium Heavy Duty Truck', 'MHDT'),
	(35, 'Medium Heavy Duty Truck (Toll)', 'Medium Heavy Duty Truck', 'MHDT'),
	(36, 'Heavy Heavy Duty Truck (Non-Toll)', 'Heavy Heavy Duty Truck', 'HHDT'),
	(37, 'Heavy Heavy Duty Truck (Toll)', 'Heavy Heavy Duty Truck', 'HHDT');
