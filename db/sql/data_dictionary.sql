...
--EXECUTE [db_meta].[add_xp] 'dimension.bike_link.bike2sep', 'MS_Description', ''
--EXECUTE [db_meta].[add_xp] 'dimension.bike_link.bike3blvd', 'MS_Description', ''
--EXECUTE [db_meta].[add_xp] 'dimension.bike_link.speed', 'MS_Description', ''
--EXECUTE [db_meta].[add_xp] 'dimension.bike_link.distance', 'MS_Description', ''
--EXECUTE [db_meta].[add_xp] 'dimensionbike_link.scenicldx', 'MS_Description', ''
...
--EXECUTE [db_meta].[add_xp] 'dimension.household.bldgsz', 'MS_Description', ''
...
--EXECUTE [db_meta].[add_xp] 'dimension.household.poverty', 'MS_Description', ''
...
--EXECUTE [db_meta].[add_xp] 'dimension.hwy_link_tod.itoll2', 'MS_Description', 'link toll cost'
...
--EXECUTE [db_meta].[add_xp] 'dimension.person.education', 'MS_Description', ''
--EXECUTE [db_meta].[add_xp] 'dimension.person.grade', 'MS_Description', ''
--EXECUTE [db_meta].[add_xp] 'dimension.person.weeks', 'MS_Description', ''
--EXECUTE [db_meta].[add_xp] 'dimension.person.hours', 'MS_Description', ''
...
--EXECUTE [db_meta].[add_xp] 'dimension.transit_route.route_name', 'MS_Description', ''
...
EXECUTE [db_meta].[add_xp] 'dimension.transit_route.op_headway', 'MS_Description', 'ABM off peak time period headway'
--EXECUTE [db_meta].[add_xp] 'dimension.transit_route.nt_headway', 'MS_Description', ''
--EXECUTE [db_meta].[add_xp] 'dimension.transit_route.nt_hour', 'MS_Description', ''
...
--EXECUTE [db_meta].[add_xp] 'fact.mgra_based_input.acres', 'MS_Description', ''
--EXECUTE [db_meta].[add_xp] 'fact.mgra_based_input.effective_acres', 'MS_Description', ''
--EXECUTE [db_meta].[add_xp] 'fact.mgra_based_input.land_acres', 'MS_Description', ''
GO
...
--EXECUTE [db_meta].[add_xp] 'fact.transit_flow.baseivtt', 'MS_Description', 'in-vehicle time for transit'
...
--EXECUTE [db_meta].[add_xp] 'fact.transit_pnr.parking_type', 'MS_Description', ''
