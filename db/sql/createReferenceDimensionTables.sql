...
CREATE TABLE [dimension].[geography] (
    ...
    CONSTRAINT pk_geography PRIMARY KEY([geography_id], [geography_set_id]),
	CONSTRAINT fk_geography_set FOREIGN KEY ([geography_set_id]) REFERENCES [dimension].[geography_set] ([geography_set_id]),
    CONSTRAINT ixuq_geography UNIQUE([mgra_13], [taz_13], [geography_set_id]) WHERE geography_id <> 0 WITH (DATA_COMPRESSION = PAGE),
