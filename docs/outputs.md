...
### CVM Establishment Synthesis model outputs (.\cvmestsynthesis)
...
#### CVM Establishment Synthesis Model Trip File ( MGRAEmpByEstSize.csv )
...
<table>
  ...
  <tr>
    <td>emp_Sector Size_Class
    </td>
    <td>Employment numbers, where Sector is gov, mil, ag_min, bus_svcs, fin_res_mgm, educ, hlth, ret, trn_wrh, con, utl, mnf, whl, ent, accm, food, oth; where Size_Class ranges 1-7.

   

</table>

#### CVM Establishment Synthesis Model Trip File ( SummarySynthEstabs.csv )
...
#### CVM Establishment Synthesis Model Trip File ( SynthEstablishments.csv )
...
<table>
  ...
  <tr>
    ...
    <td>Unique establishment id (index) for each establishment
    </td>
  </tr>
  <tr>
    <td>Industry_No
    </td>
    <td>The category of industry that the establishment belongs to (range: 1-12)
    </td>
  </tr>
  <tr>
    <td>Industry_Name
    </td>
    <td>The name of the industry that the establishment belongs to (EPO, AGM, CON 
etc.)
    </td>
  ...
  <tr>
    ...
    <td>Land Use Zone (Or the TAZ) to which the establishment belongs to
  </td>
  </tr>
  <tr>
    <td>MGRA
    </td>
    <td>The MGRA number to which the establishment belongs to
  </td>
  </tr>
  <tr>
    <td>Employees
...
### Industry No and Industry Name Definitions
...
<table>
  ...
  <tr>
   ...
   <td>Agriculture, Forestry, Fishing, and Hunting, and Mining
   </td>
  </tr>
  <tr>
   <td>2
  ...
  <tr>
   ...
   <td>Transportation and Warehousing
   </td>
  </tr>
  <tr>
   <td>8
   ...
   <td>Information, Financial, Insurance, Real Estate, and Professional Services
   </td>
  </tr>
  <tr>
   <td>9
   ...
   <td>Education, Public, and Other Services
   </td>
  </tr>
  <tr>
   <td>10
   ...
   <td>Medical and Health Services
   </td>
  </tr>
  <tr>
   <td>11
   ...
   <td>Leisure, Accommodations, and Food
   </td>
  </tr>
  <tr>
   <td>12
